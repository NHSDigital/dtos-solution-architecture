...
=======
![Participant Manager Container Diagram](path/to/image.jpg)
>>>>>>> 272bd9f (Refactor to move images to the eventcatalog and reduce number of services to reflect current solution)
