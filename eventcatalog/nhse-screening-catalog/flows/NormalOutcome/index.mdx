...
steps:
  ...
  - id: "ServiceLayer"
    ...
    next_step: 
      ...
      label: "Publish normal outcome  to pathway coordinator"

  - id: "PathwayCoordinator"
    title: "Pathway Coordinate receives normal outcome event"
    summary: "Normal Outcome events from service layer"
     # This step is a message, include the message and version
    message:
